...
public:
    ...
    QSqlQueryModel* getMembersQueryModel();     // returns the list of members as a tableview (GUI)
    QSqlQueryModel* getRecordsQueryModel();     // returns the record of sales as a tableview (GUI)
    QSqlQueryModel* getCommoditiesQueryModel(); // returns the list of commodities as a tableview (GUI)
    QSqlQueryModel* getRevenueSortedById();     // returns the list of member revenue sorted by member ID (asc. order) as a tableview (GUI)
    QSqlQueryModel* getRevenueSortedByRev();    // returns the list of member revenue sorted by revenue (asc. order) as a tableview (GUI)
    QSqlQueryModel* SortByRevenueItems();       // returns the list of commodities sorted by revenue (asc. order) as a tableview (GUI)
    QSqlQueryModel* SortByNameItems();          // returns the list of commodities sorted by item name (asc. order) as a tableview (GUI)
    QSqlQueryModel* getInventoryQueryModel();   // returns the inventory list as a tableview (GUI)
    QSqlQueryModel* getMemberUpgrades();        // returns the list of members with suggestions for account upgrade/downgrade (GUI)
    ...
    bool readRecordFile();                      // Reads a daily sales record from a file into the database. Returns true if the operation is succesful
    ...
    QSqlQueryModel* getCommoditiesQueryModelbyName(QString name);   // Searches the commodity table for a given item name. If it is found, the results are displayed as tableview (GUI)
...
private:
    ...
    QString comboDate;         // Format: MMM/DD/YYYY
